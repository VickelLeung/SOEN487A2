...
//javax.ws.rs.core.MediaType.APPLICATION_XML
    public String addBook_JSON_TEXT(Object requestEntity) throws UniformInterfaceException {
        return webResource.accept(javax.ws.rs.core.MediaType.TEXT_PLAIN).type(javax.ws.rs.core.MediaType.APPLICATION_JSON).post(String.class, requestEntity);
    }
   ...
   public String addBook_JSON_HTML(Object requestEntity) throws UniformInterfaceException {
    ...
    public String addBook_TEXT_TEXT(Object requestEntity) throws UniformInterfaceException {
        return webResource.accept(javax.ws.rs.core.MediaType.TEXT_PLAIN).type(javax.ws.rs.core.MediaType.TEXT_PLAIN).post(String.class, requestEntity);
    }
    ...
    public String addBook_TEXT_XML(Object requestEntity) throws UniformInterfaceException {
        return webResource.accept(javax.ws.rs.core.MediaType.APPLICATION_XML).type(javax.ws.rs.core.MediaType.TEXT_PLAIN).post(String.class, requestEntity);
    }
